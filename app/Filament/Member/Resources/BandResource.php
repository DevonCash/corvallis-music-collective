...
use App\Filament\Member\Resources\BandResource\Pages;
use App\Filament\Member\Resources\BandResource\RelationManagers;
use App\Models\Band;
use Filament\Forms;
        ...
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('published_at')
                    ->dateTime()
                    ->sortable(),
                Tables\Columns\TextColumn::make('home_city')
                    ->searchable(),
            ])
            ->filters([
                //
