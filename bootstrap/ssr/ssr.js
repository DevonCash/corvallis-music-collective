...
function spread$1(args, attrs_to_add) {
    ...
    req = transport.request(options, function handleResponse(res) {
      ...
      if (onDownloadProgress) {
        const transformStream = new AxiosTransformStream({
          length: utils$4.toFiniteNumber(responseLength),
...
const trackStream = (stream2, chunkSize, onProgress, onFinish, encode3) => {
  const iterator = readBytes(stream2, chunkSize, encode3);
  let bytes = 0;
...
lodash_isequal.exports;
const css$d = {
  code: ".paginator.svelte-1o26trg.svelte-1o26trg{margin:auto;display:grid;grid-template-columns:1fr auto 1fr;justify-content:center;align-items:center;gap:1rem}.paginator.svelte-1o26trg a.svelte-1o26trg{white-space:nowrap;margin-bottom:0}.paginator.svelte-1o26trg div.svelte-1o26trg{flex:0;margin-bottom:0;margin:auto}",
  map: '{"version":3,"file":"Paginator.svelte","sources":["Paginator.svelte"],"sourcesContent":["<script>\\n    import { inertia } from \\"@inertiajs/svelte\\";\\n    export let links;\\n<\/script>\\n\\n{#if links}\\n    {@const prev = links[0]}\\n    {@const next = links[links.length - 1]}\\n    {@const rest = links.slice(1, links.length - 1)}\\n    <div class=\\"paginator\\">\\n        <a\\n            use:inertia\\n            role=\\"button\\"\\n            class=\\" outline\\"\\n            disabled={!prev.url || null}\\n            href={prev.url}>{@html prev.label}</a\\n        >\\n        <div role=\\"group\\">\\n            {#each rest as link}\\n                <a\\n                    use:inertia\\n                    role=\\"button\\"\\n                    href={link.url}\\n                    class:outline={!link.active}>{link.label}</a\\n                >\\n            {/each}\\n        </div>\\n        <a\\n            use:inertia\\n            role=\\"button\\"\\n            class=\\"outline\\"\\n            disabled={!next.url || null}\\n            href={next.url}>{@html next.label}</a\\n        >\\n    </div>\\n{/if}\\n\\n<style>\\n    .paginator {\\n        margin: auto;\\n        display: grid;\\n        grid-template-columns: 1fr auto 1fr;\\n        justify-content: center;\\n        align-items: center;\\n        gap: 1rem;\\n    }\\n\\n    .paginator a {\\n        white-space: nowrap;\\n        margin-bottom: 0;\\n    }\\n\\n    .paginator div {\\n        flex: 0;\\n        margin-bottom: 0;\\n        margin: auto;\\n    }\\n</style>\\n"],"names":[],"mappings":"AAsCI,wCAAW,CACP,MAAM,CAAE,IAAI,CACZ,OAAO,CAAE,IAAI,CACb,qBAAqB,CAAE,GAAG,CAAC,IAAI,CAAC,GAAG,CACnC,eAAe,CAAE,MAAM,CACvB,WAAW,CAAE,MAAM,CACnB,GAAG,CAAE,IACT,CAEA,yBAAU,CAAC,gBAAE,CACT,WAAW,CAAE,MAAM,CACnB,aAAa,CAAE,CACnB,CAEA,yBAAU,CAAC,kBAAI,CACX,IAAI,CAAE,CAAC,CACP,aAAa,CAAE,CAAC,CAChB,MAAM,CAAE,IACZ"}'
};
...
const css$c = {
  code: ".grid.svelte-1mobtp7.svelte-1mobtp7{grid-template-columns:repeat(auto-fill, minmax(300px, 1fr))}article.svelte-1mobtp7.svelte-1mobtp7{display:flex;flex-direction:column}article.svelte-1mobtp7 .content.svelte-1mobtp7{flex:auto}",
  map: '{"version":3,"file":"ListBands.svelte","sources":["ListBands.svelte"],"sourcesContent":["<script>\\n    import { inertia } from \\"@inertiajs/svelte\\";\\n    import Paginator from \\"../../../Components/Paginator.svelte\\";\\n    export let bands;\\n<\/script>\\n\\n<header>\\n    <h1>Bands</h1>\\n</header>\\n{@debug bands}\\n<section class=\\"section\\">\\n    <search>\\n        <form>\\n            <fieldset role=\\"group\\">\\n                <input class=\\"input\\" type=\\"text\\" placeholder=\\"Search bands\\" />\\n                <button class=\\"button\\">Search</button>\\n            </fieldset>\\n        </form>\\n    </search>\\n    <div class=\\"grid\\">\\n        {#each bands.data as band}\\n            <article>\\n                <header>{band.name}</header>\\n                <div class=\\"content\\">\\n                    {band.description}\\n                </div>\\n                <footer>\\n                    <div class=\\"inset\\" role=\\"group\\">\\n                        <a role=\\"button\\" use:inertia href={`/bands/${band.id}`}\\n                            >View</a\\n                        >\\n                        <a\\n                            role=\\"button\\"\\n                            use:inertia\\n                            href={`/admin/bands/${band.id}/edit`}>Edit</a\\n                        >\\n                    </div>\\n                </footer>\\n            </article>\\n        {/each}\\n    </div>\\n    <Paginator links={bands.links} />\\n</section>\\n\\n<style>\\n    .grid {\\n        grid-template-columns: repeat(auto-fill, minmax(300px, 1fr));\\n    }\\n\\n    article {\\n        display: flex;\\n        flex-direction: column;\\n    }\\n    article .content {\\n        flex: auto;\\n    }\\n</style>\\n"],"names":[],"mappings":"AA6CI,mCAAM,CACF,qBAAqB,CAAE,OAAO,SAAS,CAAC,CAAC,OAAO,KAAK,CAAC,CAAC,GAAG,CAAC,CAC/D,CAEA,qCAAQ,CACJ,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MACpB,CACA,sBAAO,CAAC,uBAAS,CACb,IAAI,CAAE,IACV"}'
};
const ListBands = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { bands } = $$props;
...
const CommunityEventGuidelines = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<main><nav aria-label="breadcrumb"><ul><li><a href="/" data-svelte-h="svelte-1o2t4kz">Home</a></li> <li><a href="/Events" data-svelte-h="svelte-r9k2ag">Events</a></li> <li data-svelte-h="svelte-9pqn8w">Community Event Guidelines</li></ul></nav> <article data-svelte-h="svelte-1sdalpm"><h2>Community Event Guidelines</h2> <p>The Corvallis Music Collective is a community-driven organization
            ...
            that we can continue to provide this service to the community.</p> <ul><li>Events must be music-related and take place in the Corvallis
                area.</li> <li>Events with a cover charge must feature at least one band or
                artist from the Corvallis area.</li> <li>Tickets must available to purchase by the public and the event
                should not require a membership or subscription to attend.</li> <li>Events cannot be held at private residences or other non-public
                venues.</li> <li>Events must comply with local laws and regulations, including
                those related to public health and safety.</li> <li>Events must be respectful and inclusive of all community
                members, regardless of cultural background or identity.</li></ul></article></main>`;
});
const __vite_glob_0_1 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: CommunityEventGuidelines
}, Symbol.toStringTag, { value: "Module" }));
...
const send = (host, params, callback) => {
  ...
  switch (params.type) {
    ...
    case "custom": {
      ...
      path2 += uri2.slice(0, 1) === "/" ? uri2.slice(1) : uri2;
      break;
    }
    default:
      callback("abort", 400);
...
const Icon = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  {
    {
      const iconData = checkIconState($$props.icon, state2, mounted, loaded, onLoad);
...
const css$b = {
  code: "div.grid.svelte-1mibein{grid-template-columns:2fr 1fr}.widgets.svelte-1mibein{display:flex;flex-direction:column;gap:1rem}@media(max-width: 768px){div.grid.svelte-1mibein{grid-template-columns:1fr}}",
  map: `{"version":3,"file":"Donate.svelte","sources":["Donate.svelte"],"sourcesContent":["<main>\\n    <h1>Donate</h1>\\n    <div class=\\"grid\\">\\n        <section>\\n            <article>\\n                <figure>\\n                    <img\\n                        src=\\"/building_fund.png\\"\\n                        alt=\\"A cartoon illustration of a building with a sign that reads 'Corvallis Music Collective'\\"\\n                    />\\n                </figure>\\n                <h2>Help us find a home!</h2>\\n                <p>\\n                    We are currently raising funds to secure a location to work\\n                    as a meeting place, small venue, and community practice\\n                    space. If you can support us, please consider donating using\\n                    the form on this page!\\n                </p>\\n                <p>\\n                    If it makes sense for you, please consider the monthly\\n                    donation option. Monthly donations help us plan for the\\n                    future and even smaller contributions go a long way to\\n                    helping us reach our goals.\\n                </p>\\n                <p>\\n                    Corvallis Music Collective is a 501(c)(3) non-profit, so\\n                    your donation is tax-deductable!\\n                </p>\\n                <p>\\n                    If you would like to contribute in other ways, check out our <a\\n                        href=\\"/volunteer\\">volunteer page</a\\n                    >!\\n                </p>\\n            </article>\\n        </section>\\n        <section class=\\"widgets\\">\\n            <givebutter-widget id=\\"p7EeDL\\"></givebutter-widget>\\n            <givebutter-widget id=\\"gOm4Dj\\"></givebutter-widget>\\n        </section>\\n    </div>\\n</main>\\n\\n<style>\\n    div.grid {\\n        grid-template-columns: 2fr 1fr;\\n    }\\n    .widgets {\\n        display: flex;\\n        flex-direction: column;\\n        gap: 1rem;\\n    }\\n\\n    @media (max-width: 768px) {\\n        div.grid {\\n            grid-template-columns: 1fr;\\n        }\\n    }\\n</style>\\n"],"names":[],"mappings":"AA2CI,GAAG,oBAAM,CACL,qBAAqB,CAAE,GAAG,CAAC,GAC/B,CACA,uBAAS,CACL,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,GAAG,CAAE,IACT,CAEA,MAAO,YAAY,KAAK,CAAE,CACtB,GAAG,oBAAM,CACL,qBAAqB,CAAE,GAC3B,CACJ"}`
};
const Donate = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<main data-svelte-h="svelte-1mmiipb"><h1>Donate</h1> <div class="grid svelte-1mibein"><section><article><figure><img src="/building_fund.png" alt="A cartoon illustration of a building with a sign that reads 'Corvallis Music Collective'"></figure> <h2>Help us find a home!</h2> <p>We are currently raising funds to secure a location to work
                    ...
                    donation option. Monthly donations help us plan for the
                    future and even smaller contributions go a long way to
                    helping us reach our goals.</p> <p>Corvallis Music Collective is a 501(c)(3) non-profit, so
                    your donation is tax-deductable!</p> <p>If you would like to contribute in other ways, check out our <a href="/volunteer">volunteer page</a>!</p></article></section> <section class="widgets svelte-1mibein"><givebutter-widget id="p7EeDL"></givebutter-widget> <givebutter-widget id="gOm4Dj"></givebutter-widget></section></div> </main>`;
});
...
const css$a = {
  code: ".info.grid.svelte-1sqao86.svelte-1sqao86{grid-template-columns:2fr 1fr}label.svelte-1sqao86.svelte-1sqao86:has(figure){display:flex;flex-direction:column;cursor:pointer}label.svelte-1sqao86 figure.svelte-1sqao86{flex:auto;background:var(--pico-form-element-border-color);border-radius:var(--pico-border-radius)}label.svelte-1sqao86 figure img.svelte-1sqao86{max-height:100%}.alert.svelte-1sqao86.svelte-1sqao86{padding:1rem;margin:1rem 0;border:4px solid currentColor;border-radius:var(--pico-border-radius)}.alert.success.svelte-1sqao86.svelte-1sqao86{background:var(--pico-success-color);color:var(--pico-form-element-valid-active-border-color)}.alert.error.svelte-1sqao86.svelte-1sqao86{background:var(--pico-error-color);color:var(--pico-form-element-invalid-active-border-color)}@media(max-width: 1024px){.info.grid.svelte-1sqao86.svelte-1sqao86{grid-template-columns:1fr 1fr}}@media(max-width: 768px){.info.grid.svelte-1sqao86.svelte-1sqao86{grid-template-columns:1fr}}",
  map: `{"version":3,"file":"CreateEvent.svelte","sources":["CreateEvent.svelte"],"sourcesContent":["<script>\\n    import { inertia } from \\"@inertiajs/svelte\\";\\n\\n    export let csrf;\\n    export let errors;\\n    let posterPreview = \\"\\";\\n\\n    let message = null;\\n\\n    function onChange(event) {\\n        if (event.target.files && event.target.files[0]) {\\n            var reader = new FileReader();\\n            reader.onload = function (e) {\\n                posterPreview = e.target.result;\\n            };\\n            reader.readAsDataURL(event.target.files[0]);\\n        }\\n    }\\n\\n    function onSubmit(ev) {\\n        ev.preventDefault();\\n        const form = ev.target;\\n        form.classList.add(\\"loading\\");\\n        const formData = new FormData(form);\\n        console.log(formData.getAll(\\"tags\\"));\\n        fetch(\\"/events\\", {\\n            method: \\"POST\\",\\n            body: formData,\\n        })\\n            .then((res) => {\\n                if (res.status > 299) {\\n                    throw new Error(res);\\n                }\\n                form.classList.remove(\\"loading\\");\\n                form.reset();\\n                posterPreview = \\"\\";\\n                message = {\\n                    type: \\"success\\",\\n                    text: \\"Event submitted successfully!\\",\\n                };\\n            })\\n            .catch((error) => {\\n                form.classList.remove(\\"loading\\");\\n                message = {\\n                    type: \\"error\\",\\n                    text: \\"There was an error submitting your event, please try again later.\\",\\n                };\\n                console.error(\\"Error:\\", error);\\n            })\\n            .finally(() => {\\n                form.classList.remove(\\"loading\\");\\n                setTimeout(() => {\\n                    message = \\"\\";\\n                }, 5000);\\n            });\\n    }\\n<\/script>\\n\\n{@debug errors}\\n<main>\\n    <article>\\n        <h2>Submit Community Event</h2>\\n        <p>\\n            Have an event you'd like to share? Fill out the form below to submit\\n            your event to our calendar!\\n        </p>\\n        {#if message}\\n            <div class=\\"alert {message.type}\\" role=\\"alert\\">\\n                {message.text}\\n            </div>\\n        {/if}\\n        <form on:submit={onSubmit}>\\n            <input type=\\"hidden\\" name=\\"_token\\" value={csrf} />\\n            <section class=\\"info grid\\">\\n                <div>\\n                    <label>\\n                        Name\\n                        <input required name=\\"name\\" type=\\"text\\" />\\n                    </label>\\n                    <div class=\\"grid\\">\\n                        <label>\\n                            Date\\n                            <input required name=\\"start_date\\" type=\\"date\\" />\\n                        </label>\\n                        <label>\\n                            Time\\n                            <input required name=\\"start_time\\" type=\\"time\\" />\\n                        </label>\\n                    </div>\\n                    <label>\\n                        Description\\n                        <textarea\\n                            rows=\\"5\\"\\n                            name=\\"description\\"\\n                            required\\n                            placeholder=\\"Include any relevant information about your event here, including who's playing, ticket prices, venue information, and any other details you'd like to share.\\"\\n                        ></textarea>\\n                    </label>\\n                </div>\\n                <label>\\n                    Poster\\n                    <figure style=\\"height: 25vh; padding: .5rem;\\" class=\\"grid\\">\\n                        {#if posterPreview}\\n                            <img\\n                                style=\\"height: 100%; width: auto; margin:auto;\\"\\n                                src={posterPreview}\\n                                alt=\\"Preview of poster file upload\\"\\n                            />\\n                        {:else}\\n                            <img\\n                                style=\\"filter: grayscale(.8); max-width: 80%;  margin:auto; position: relative; left: 8%; opacity: .2;\\"\\n                                aria-hidden\\n                                alt=\\"Corvallis Music Collective Logo Watermark\\"\\n                                src=\\"/logo.svg\\"\\n                            />\\n                        {/if}\\n                        <figcaption style=\\"display: none;\\">\\n                            Preview of poster file upload\\n                        </figcaption>\\n                    </figure>\\n                    <input on:change={onChange} name=\\"poster\\" type=\\"file\\" />\\n                </label>\\n            </section>\\n            <section>\\n                <fieldset\\n                    class=\\"grid\\"\\n                    style=\\"grid-template-columns: autofill(100px, 1fr)\\"\\n                >\\n                    <legend style=\\"grid-column: 1 / -1\\">Other Info</legend>\\n                    <label>\\n                        <input type=\\"checkbox\\" name=\\"tags[]\\" value=\\"Free\\" />\\n                        Free\\n                    </label>\\n                    <label>\\n                        <input\\n                            type=\\"checkbox\\"\\n                            name=\\"tags[]\\"\\n                            value=\\"Age Restricted\\"\\n                        />\\n                        Age Restricted\\n                    </label>\\n                    <label>\\n                        <input\\n                            type=\\"checkbox\\"\\n                            name=\\"tags[]\\"\\n                            value=\\"Masks Mandatory\\"\\n                        />\\n                        Masks Mandatory\\n                    </label>\\n\\n                    <label>\\n                        <input\\n                            type=\\"checkbox\\"\\n                            name=\\"tags[]\\"\\n                            value=\\"Alcohol Served\\"\\n                        />\\n                        Alcohol Served\\n                    </label>\\n                </fieldset>\\n                <fieldset>\\n                    <legend>Community Guidelines</legend>\\n                    <label>\\n                        <input type=\\"checkbox\\" name=\\"terms\\" required />\\n                        This event complies with our\\n                        <a href=\\"/events/community-events\\">posting guidelines</a\\n                        >\\n                    </label>\\n                </fieldset>\\n            </section>\\n\\n            <button type=\\"submit\\">Submit Event</button>\\n        </form>\\n    </article>\\n</main>\\n\\n<style>\\n    .info.grid {\\n        grid-template-columns: 2fr 1fr;\\n    }\\n\\n    label:has(figure) {\\n        display: flex;\\n        flex-direction: column;\\n        cursor: pointer;\\n    }\\n\\n    label figure {\\n        flex: auto;\\n        background: var(--pico-form-element-border-color);\\n        border-radius: var(--pico-border-radius);\\n    }\\n\\n    label figure img {\\n        max-height: 100%;\\n    }\\n\\n    .alert {\\n        padding: 1rem;\\n        margin: 1rem 0;\\n        border: 4px solid currentColor;\\n        border-radius: var(--pico-border-radius);\\n    }\\n\\n    .alert.success {\\n        background: var(--pico-success-color);\\n        color: var(--pico-form-element-valid-active-border-color);\\n    }\\n\\n    .alert.error {\\n        background: var(--pico-error-color);\\n        color: var(--pico-form-element-invalid-active-border-color);\\n    }\\n\\n    @media (max-width: 1024px) {\\n        .info.grid {\\n            grid-template-columns: 1fr 1fr;\\n        }\\n    }\\n\\n    @media (max-width: 768px) {\\n        .info.grid {\\n            grid-template-columns: 1fr;\\n        }\\n    }\\n</style>\\n"],"names":[],"mappings":"AAgLI,KAAK,mCAAM,CACP,qBAAqB,CAAE,GAAG,CAAC,GAC/B,CAEA,mCAAK,KAAK,MAAM,CAAE,CACd,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,MAAM,CAAE,OACZ,CAEA,oBAAK,CAAC,qBAAO,CACT,IAAI,CAAE,IAAI,CACV,UAAU,CAAE,IAAI,gCAAgC,CAAC,CACjD,aAAa,CAAE,IAAI,oBAAoB,CAC3C,CAEA,oBAAK,CAAC,MAAM,CAAC,kBAAI,CACb,UAAU,CAAE,IAChB,CAEA,oCAAO,CACH,OAAO,CAAE,IAAI,CACb,MAAM,CAAE,IAAI,CAAC,CAAC,CACd,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,YAAY,CAC9B,aAAa,CAAE,IAAI,oBAAoB,CAC3C,CAEA,MAAM,sCAAS,CACX,UAAU,CAAE,IAAI,oBAAoB,CAAC,CACrC,KAAK,CAAE,IAAI,6CAA6C,CAC5D,CAEA,MAAM,oCAAO,CACT,UAAU,CAAE,IAAI,kBAAkB,CAAC,CACnC,KAAK,CAAE,IAAI,+CAA+C,CAC9D,CAEA,MAAO,YAAY,MAAM,CAAE,CACvB,KAAK,mCAAM,CACP,qBAAqB,CAAE,GAAG,CAAC,GAC/B,CACJ,CAEA,MAAO,YAAY,KAAK,CAAE,CACtB,KAAK,mCAAM,CACP,qBAAqB,CAAE,GAC3B,CACJ"}`
};
const CreateEvent = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { csrf } = $$props;
  let { errors } = $$props;
...
const css$9 = {
  code: 'figure.svelte-pxz0ax.svelte-pxz0ax.svelte-pxz0ax{flex:0 0 auto;display:flex}img.svelte-pxz0ax.svelte-pxz0ax.svelte-pxz0ax{flex:auto;height:100%}.desc.svelte-pxz0ax.svelte-pxz0ax.svelte-pxz0ax{flex:1 1 auto}li.event.svelte-pxz0ax.svelte-pxz0ax.svelte-pxz0ax{display:flex;flex-direction:row-reverse;align-items:stretch;gap:1rem;margin-bottom:1rem;padding:0.5rem 0;border-bottom:4px solid var(--cmc-yellow)}.content.svelte-pxz0ax.svelte-pxz0ax.svelte-pxz0ax{display:flex;flex-direction:column}.content.svelte-pxz0ax section.svelte-pxz0ax.svelte-pxz0ax{flex:1 1 auto}figure.svelte-pxz0ax.svelte-pxz0ax.svelte-pxz0ax{aspect-ratio:3/4;height:16rem;border-radius:var(--pico-border-radius);overflow:hidden}.bands.svelte-pxz0ax ul.svelte-pxz0ax.svelte-pxz0ax{display:inline;padding:0;list-style:none;gap:0.5rem}.bands.svelte-pxz0ax li.svelte-pxz0ax.svelte-pxz0ax{display:inline;list-style:none}.bands.svelte-pxz0ax li.svelte-pxz0ax:not(:last-child) a.svelte-pxz0ax::after{content:","}hgroup.svelte-pxz0ax a h2.svelte-pxz0ax.svelte-pxz0ax{margin-bottom:0}@media(max-width: 768px){li.svelte-pxz0ax.svelte-pxz0ax.svelte-pxz0ax{flex-direction:column}}.tags.svelte-pxz0ax.svelte-pxz0ax.svelte-pxz0ax{display:flex;align-items:center;gap:0.5em}.tags.svelte-pxz0ax a[role="button"].svelte-pxz0ax.svelte-pxz0ax{font-size:smaller;padding:0.25rem 0.5rem;margin:0}.event.svelte-pxz0ax .iconify{color:var(--cmc-blue)}ul.price.svelte-pxz0ax.svelte-pxz0ax.svelte-pxz0ax{padding:0;margin:0.5rem 0}.price.svelte-pxz0ax li.svelte-pxz0ax.svelte-pxz0ax{list-style:none}.price.svelte-pxz0ax li.svelte-pxz0ax:not(:first-child) .iconify{visibility:hidden}',
  map: '{"version":3,"file":"EventLi.svelte","sources":["EventLi.svelte"],"sourcesContent":["<script>\\n    import Icon from \\"@iconify/svelte\\";\\n    import { inertia } from \\"@inertiajs/svelte\\";\\n    export let event;\\n\\n    function format(isoDate) {\\n        return new Date(isoDate).toLocaleString(undefined, {\\n            month: \\"long\\",\\n            day: \\"numeric\\",\\n        });\\n    }\\n\\n    function formatTime(isoDate) {\\n        return new Date(isoDate).toLocaleTimeString(undefined, {\\n            hour: \\"numeric\\",\\n            minute: \\"numeric\\",\\n            ampm: \\"short\\",\\n        });\\n    }\\n<\/script>\\n\\n<li class=\\"event\\">\\n    <figure>\\n        <img src={event.poster} alt=\\"Poster for {event.name}\\" />\\n        <figcaption style=\\"display: none;\\">Poster for {event.name}</figcaption>\\n    </figure>\\n    <div class=\\"content\\">\\n        <hgroup>\\n            <div class=\\"time\\" style=\\"color:#e5771e;\\">\\n                <time datetime={event.start_time}>\\n                    <strong class=\\"day\\">{format(event.start_time)}</strong>\\n                    <span class=\\"start\\">▪ {formatTime(event.start_time)}</span>\\n                </time>\\n                {#if event.end_time}\\n                    - <time datetime={event.end_time}>\\n                        <span class=\\"end\\">{formatTime(event.end_time)}</span>\\n                    </time>\\n                {/if}\\n            </div>\\n            <h2 id={event.id}>\\n                <a use:inertia href=\\"/events/{event.id}\\" style=\\"color:inherit;\\"\\n                    >{event.name}</a\\n                >\\n            </h2>\\n            {#if event.venue}\\n                <div class=\\"venue\\">\\n                    <Icon icon=\\"mdi:alternate-email\\" />\\n                    {#if event.venue.link}\\n                        <a target=\\"_blank\\" href={event.venue.link}\\n                            >{event.venue?.name}\\n                            <Icon icon=\\"mdi:external-link\\" /></a\\n                        >\\n                    {:else}\\n                        {event.venue?.name}\\n                    {/if}\\n                </div>\\n            {/if}\\n        </hgroup>\\n        <section class=\\"desc\\">\\n            {@html event.description}\\n        </section>\\n\\n        {#if event.bands.length > 0}\\n            <div class=\\"bands\\">\\n                <Icon icon=\\"mdi:account-music\\" />\\n                <ul>\\n                    {#each event.bands as band}\\n                        <li>\\n                            <a use:inertia href=\\"/bands/{band.id}\\"\\n                                >{band.name}</a\\n                            >\\n                        </li>\\n                    {/each}\\n                </ul>\\n            </div>\\n        {/if}\\n\\n        {#if event.price?.length > 0}\\n            <ul class=\\"price\\">\\n                {#each event.price as { label, price }}\\n                    <li>\\n                        <Icon icon=\\"mdi:ticket\\" />\\n                        <strong>{label}</strong>: {price}\\n                    </li>\\n                {/each}\\n            </ul>\\n        {/if}\\n        {#if event.links?.length > 0}\\n            <nav>\\n                <ul>\\n                    {#each event.links as link}\\n                        <li><a href={link.url}>{link.name}</a></li>\\n                    {/each}\\n                </ul>\\n            </nav>\\n        {/if}\\n        <div class=\\"tags\\">\\n            <Icon icon=\\"mdi:hashtag\\" />\\n            {#each event.tags as tag}\\n                <a\\n                    role=\\"button\\"\\n                    class=\\"outline\\"\\n                    use:inertia\\n                    href=\\"/events?tag={tag}\\">{tag}</a\\n                >\\n            {/each}\\n        </div>\\n    </div>\\n</li>\\n\\n<style>\\n    figure {\\n        flex: 0 0 auto;\\n        display: flex;\\n    }\\n    img {\\n        flex: auto;\\n        height: 100%;\\n    }\\n\\n    .desc {\\n        flex: 1 1 auto;\\n    }\\n    li.event {\\n        display: flex;\\n        flex-direction: row-reverse;\\n        align-items: stretch;\\n        gap: 1rem;\\n        margin-bottom: 1rem;\\n        padding: 0.5rem 0;\\n        border-bottom: 4px solid var(--cmc-yellow);\\n    }\\n\\n    .content {\\n        display: flex;\\n        flex-direction: column;\\n    }\\n\\n    .content section {\\n        flex: 1 1 auto;\\n    }\\n\\n    figure {\\n        aspect-ratio: 3/4;\\n        height: 16rem;\\n        border-radius: var(--pico-border-radius);\\n        overflow: hidden;\\n    }\\n\\n    .bands ul {\\n        display: inline;\\n        padding: 0;\\n        list-style: none;\\n        gap: 0.5rem;\\n    }\\n    .bands li {\\n        display: inline;\\n        list-style: none;\\n    }\\n    .bands li:not(:last-child) a::after {\\n        content: \\",\\";\\n    }\\n\\n    hgroup a h2 {\\n        margin-bottom: 0;\\n    }\\n\\n    @media (max-width: 768px) {\\n        li {\\n            flex-direction: column;\\n        }\\n    }\\n\\n    .tags {\\n        display: flex;\\n        align-items: center;\\n        gap: 0.5em;\\n    }\\n    .tags a[role=\\"button\\"] {\\n        font-size: smaller;\\n        padding: 0.25rem 0.5rem;\\n        margin: 0;\\n    }\\n\\n    .event :global(.iconify) {\\n        color: var(--cmc-blue);\\n    }\\n\\n    ul.price {\\n        padding: 0;\\n        margin: 0.5rem 0;\\n    }\\n    .price li {\\n        list-style: none;\\n    }\\n\\n    .price li:not(:first-child) :global(.iconify) {\\n        visibility: hidden;\\n    }\\n</style>\\n"],"names":[],"mappings":"AA+GI,gDAAO,CACH,IAAI,CAAE,CAAC,CAAC,CAAC,CAAC,IAAI,CACd,OAAO,CAAE,IACb,CACA,6CAAI,CACA,IAAI,CAAE,IAAI,CACV,MAAM,CAAE,IACZ,CAEA,+CAAM,CACF,IAAI,CAAE,CAAC,CAAC,CAAC,CAAC,IACd,CACA,EAAE,gDAAO,CACL,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,WAAW,CAC3B,WAAW,CAAE,OAAO,CACpB,GAAG,CAAE,IAAI,CACT,aAAa,CAAE,IAAI,CACnB,OAAO,CAAE,MAAM,CAAC,CAAC,CACjB,aAAa,CAAE,GAAG,CAAC,KAAK,CAAC,IAAI,YAAY,CAC7C,CAEA,kDAAS,CACL,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MACpB,CAEA,sBAAQ,CAAC,mCAAQ,CACb,IAAI,CAAE,CAAC,CAAC,CAAC,CAAC,IACd,CAEA,gDAAO,CACH,YAAY,CAAE,CAAC,CAAC,CAAC,CACjB,MAAM,CAAE,KAAK,CACb,aAAa,CAAE,IAAI,oBAAoB,CAAC,CACxC,QAAQ,CAAE,MACd,CAEA,oBAAM,CAAC,8BAAG,CACN,OAAO,CAAE,MAAM,CACf,OAAO,CAAE,CAAC,CACV,UAAU,CAAE,IAAI,CAChB,GAAG,CAAE,MACT,CACA,oBAAM,CAAC,8BAAG,CACN,OAAO,CAAE,MAAM,CACf,UAAU,CAAE,IAChB,CACA,oBAAM,CAAC,gBAAE,KAAK,WAAW,CAAC,CAAC,eAAC,OAAQ,CAChC,OAAO,CAAE,GACb,CAEA,oBAAM,CAAC,CAAC,CAAC,8BAAG,CACR,aAAa,CAAE,CACnB,CAEA,MAAO,YAAY,KAAK,CAAE,CACtB,4CAAG,CACC,cAAc,CAAE,MACpB,CACJ,CAEA,+CAAM,CACF,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,GAAG,CAAE,KACT,CACA,mBAAK,CAAC,CAAC,CAAC,IAAI,CAAC,QAAQ,6BAAE,CACnB,SAAS,CAAE,OAAO,CAClB,OAAO,CAAE,OAAO,CAAC,MAAM,CACvB,MAAM,CAAE,CACZ,CAEA,oBAAM,CAAS,QAAU,CACrB,KAAK,CAAE,IAAI,UAAU,CACzB,CAEA,EAAE,gDAAO,CACL,OAAO,CAAE,CAAC,CACV,MAAM,CAAE,MAAM,CAAC,CACnB,CACA,oBAAM,CAAC,8BAAG,CACN,UAAU,CAAE,IAChB,CAEA,oBAAM,CAAC,gBAAE,KAAK,YAAY,CAAC,CAAS,QAAU,CAC1C,UAAU,CAAE,MAChB"}'
};
function format$1(isoDate) {
  return new Date(isoDate).toLocaleString(void 0, { month: "long", day: "numeric" });
}
function formatTime(isoDate) {
  return new Date(isoDate).toLocaleTimeString(void 0, {
    hour: "numeric",
    minute: "numeric",
    ampm: "short"
  });
}
const EventLi = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  var _a, _b, _c, _d;
  let { event } = $$props;
  ...
  })}</ul>` : ``} ${((_d = event.links) == null ? void 0 : _d.length) > 0 ? `<nav><ul>${each(event.links, (link) => {
    return `<li class="svelte-pxz0ax"><a${add_attribute("href", link.url, 0)} class="svelte-pxz0ax">${escape$1(link.name)}</a></li>`;
  })}</ul></nav>` : ``} <div class="tags svelte-pxz0ax">${validate_component(Icon, "Icon").$$render($$result, { icon: "mdi:hashtag" }, {}, {})} ${each(event.tags, (tag) => {
    return `<a role="button" class="outline svelte-pxz0ax" href="${"/events?tag=" + escape$1(tag, true)}">${escape$1(tag)}</a>`;
  })}</div></div> </li>`;
});
...
function $14e0f24ef4ac5c92$export$68781ddf31c0090f(a, b2) {
  return a.calendar.toJulianDay(a) - b2.calendar.toJulianDay(b2);
}
function $14e0f24ef4ac5c92$export$c19a80a9721b80f6(a, b2) {
  return $14e0f24ef4ac5c92$var$timeToMs(a) - $14e0f24ef4ac5c92$var$timeToMs(b2);
}
...
function $11d87f3f76e88657$export$59c99f3515d3493f(ms2, timeZone) {
  ...
  if (ms2 > 0 && timeZone === $14e0f24ef4ac5c92$export$aa8b41735afcabd2()) return new Date(ms2).getTimezoneOffset() * -6e4;
...
function $11d87f3f76e88657$export$1b96692a1ba042ac(ms2, timeZone) {
  let offset = $11d87f3f76e88657$export$59c99f3515d3493f(ms2, timeZone);
  let date = new Date(ms2 + offset);
...
function $735220c2d4774dd3$var$nonNegativeMod(a, b2) {
  let result = a % b2;
...
function $735220c2d4774dd3$export$96b1d28349274637(dateTime, duration) {
  ...
  if (duration.years != null && duration.years !== 0 || duration.months != null && duration.months !== 0 || duration.weeks != null && duration.weeks !== 0 || duration.days != null && duration.days !== 0) {
    ...
    ms2 = $11d87f3f76e88657$export$5107c82f94518f5c(res2, dateTime.timeZone);
  } else
    ms2 = $11d87f3f76e88657$export$bd4fb2bc8bb06fb(dateTime) - dateTime.offset;
  ms2 += duration.milliseconds || 0;
  ms2 += (duration.seconds || 0) * 1e3;
  ms2 += (duration.minutes || 0) * 6e4;
  ms2 += (duration.hours || 0) * 36e5;
  let res = $11d87f3f76e88657$export$1b96692a1ba042ac(ms2, dateTime.timeZone);
...
function $735220c2d4774dd3$export$9a297d111fc86b79(dateTime, field, amount, options) {
  switch (field) {
    case "hour": {
      ...
      ].filter((ms3) => $11d87f3f76e88657$export$1b96692a1ba042ac(ms3, dateTime.timeZone).day === minDate.day)[0];
      ...
      ].filter((ms3) => $11d87f3f76e88657$export$1b96692a1ba042ac(ms3, dateTime.timeZone).day === maxDate.day).pop();
      let ms2 = $11d87f3f76e88657$export$bd4fb2bc8bb06fb(dateTime) - dateTime.offset;
      ...
      return $11d87f3f76e88657$export$b4a036af3fc0b032($11d87f3f76e88657$export$1b96692a1ba042ac(ms2, dateTime.timeZone), dateTime.calendar);
    }
    case "minute":
    case "second":
    case "millisecond":
    ...
    case "day": {
      ...
      let ms2 = $11d87f3f76e88657$export$5107c82f94518f5c(res, dateTime.timeZone);
      return $11d87f3f76e88657$export$b4a036af3fc0b032($11d87f3f76e88657$export$1b96692a1ba042ac(ms2, dateTime.timeZone), dateTime.calendar);
    }
    default:
      throw new Error("Unsupported field " + field);
...
function $735220c2d4774dd3$export$31b5430eb18be4f8(dateTime, fields, disambiguation) {
  ...
  let ms2 = $11d87f3f76e88657$export$5107c82f94518f5c(res, dateTime.timeZone, disambiguation);
  return $11d87f3f76e88657$export$b4a036af3fc0b032($11d87f3f76e88657$export$1b96692a1ba042ac(ms2, dateTime.timeZone), dateTime.calendar);
}
...
(function(module, exports) {
  (function() {
    ...
    var runInContext = function runInContext2(context) {
      ...
      function split(string, separator2, limit2) {
        if (limit2 && typeof limit2 != "number" && isIterateeCall(string, separator2, limit2)) {
          separator2 = limit2 = undefined$12;
        }
      ...
      function truncate(string, options) {
        ...
        if (separator2 === undefined$12) {
          return result2 + omission;
        }
        if (strSymbols) {
          end += result2.length - end;
        }
        if (isRegExp3(separator2)) {
          if (string.slice(end).search(separator2)) {
            var match, substring = result2;
            if (!separator2.global) {
              separator2 = RegExp2(separator2.source, toString3(reFlags.exec(separator2)) + "g");
            }
...
const css$8 = {
  code: ".day.svelte-143bans{font-size:inherit;display:flex;align-items:center;justify-content:center;padding:0em;margin:0;border-radius:0.5em;text-align:center;aspect-ratio:1/1;height:3em}p.day.today.svelte-143bans{border:1px solid currentColor}th.svelte-143bans{padding:0.5em 0}td.svelte-143bans{padding:0.2em}table.svelte-143bans{width:unset}:root{scroll-behavior:smooth}",
  map: '{"version":3,"file":"Calendar.svelte","sources":["Calendar.svelte"],"sourcesContent":["<script>\\n    import { groupBy } from \\"lodash\\";\\n    import {\\n        startOfWeek,\\n        getWeeksInMonth,\\n        today as getToday,\\n        getLocalTimeZone,\\n    } from \\"@internationalized/date\\";\\n\\n    export let month;\\n    export let events = [];\\n    console.log(month);\\n\\n    let today = getToday(getLocalTimeZone());\\n    let byDay, weeks;\\n    $: {\\n        byDay =\\n            events.length &&\\n            groupBy(events, (event) => {\\n                const date = new Date(event.start_time);\\n                return date?.getDate();\\n            });\\n\\n        const firstCalDay = startOfWeek(month, \\"en-US\\");\\n        const numWeeks = getWeeksInMonth(month, \\"en-US\\");\\n        weeks = Array(numWeeks).fill([]);\\n        for (let w = 0; w < weeks.length; w++) {\\n            weeks[w] = Array(7)\\n                .fill(0)\\n                .map((_, i) => firstCalDay.add({ weeks: w, days: i }));\\n        }\\n    }\\n<\/script>\\n\\n{@debug today}\\n<table>\\n    <caption>\\n        <h3>\\n            {month.toDate(getLocalTimeZone()).toLocaleDateString(\\"en-US\\", {\\n                month: \\"long\\",\\n                year: \\"numeric\\",\\n            })}\\n        </h3>\\n    </caption>\\n    <thead>\\n        <tr>\\n            {#each weeks[0] as day}\\n                <th style=\\"text-align: center;\\"\\n                    >{day\\n                        .toDate(getLocalTimeZone())\\n                        .toLocaleDateString(\\"en-US\\", {\\n                            weekday: \\"short\\",\\n                        })}</th\\n                >\\n            {/each}\\n        </tr>\\n    </thead>\\n    {#each weeks as week}\\n        <tr>\\n            {#each week as day}\\n                {@const inMonth = day.month === month.month}\\n                <td>\\n                    {#if inMonth}\\n                        {#if byDay && byDay[day.day]}\\n                            {@const first = byDay[day.day][0]}\\n                            <a\\n                                class=\\"day\\"\\n                                class:outline={today.compare(day) === 0}\\n                                class:secondary={today.compare(day) > 0}\\n                                role=\\"button\\"\\n                                href=\\"#{first.id}\\"\\n                            >\\n                                {day.day}\\n                            </a>\\n                        {:else}\\n                            <p\\n                                class=\\"day\\"\\n                                class:today={today.compare(day) === 0}\\n                                class:outOfMonth={!inMonth}\\n                            >\\n                                {day.day}\\n                            </p>\\n                        {/if}\\n                    {/if}\\n                </td>\\n            {/each}\\n        </tr>\\n    {/each}\\n</table>\\n\\n<style>\\n    .day {\\n        font-size: inherit;\\n        display: flex;\\n        align-items: center;\\n        justify-content: center;\\n        padding: 0em;\\n\\n        margin: 0;\\n        border-radius: 0.5em;\\n        text-align: center;\\n        aspect-ratio: 1/1;\\n        height: 3em;\\n    }\\n\\n    p.day.today {\\n        border: 1px solid currentColor;\\n    }\\n\\n    th {\\n        padding: 0.5em 0;\\n    }\\n\\n    td {\\n        padding: 0.2em;\\n    }\\n    table {\\n        width: unset;\\n    }\\n    :global(:root) {\\n        scroll-behavior: smooth;\\n    }\\n</style>\\n"],"names":[],"mappings":"AA2FI,mBAAK,CACD,SAAS,CAAE,OAAO,CAClB,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,eAAe,CAAE,MAAM,CACvB,OAAO,CAAE,GAAG,CAEZ,MAAM,CAAE,CAAC,CACT,aAAa,CAAE,KAAK,CACpB,UAAU,CAAE,MAAM,CAClB,YAAY,CAAE,CAAC,CAAC,CAAC,CACjB,MAAM,CAAE,GACZ,CAEA,CAAC,IAAI,qBAAO,CACR,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,YACtB,CAEA,iBAAG,CACC,OAAO,CAAE,KAAK,CAAC,CACnB,CAEA,iBAAG,CACC,OAAO,CAAE,KACb,CACA,oBAAM,CACF,KAAK,CAAE,KACX,CACQ,KAAO,CACX,eAAe,CAAE,MACrB"}'
};
const Calendar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { month } = $$props;
  let { events: events2 = [] } = $$props;
  console.log(month);
  let today = $14e0f24ef4ac5c92$export$d0bdf45af03a6ea3($14e0f24ef4ac5c92$export$aa8b41735afcabd2());
  let byDay, weeks;
  ...
  {
    {
      byDay = events2.length && lodashExports.groupBy(events2, (event) => {
        const date = new Date(event.start_time);
        return date == null ? void 0 : date.getDate();
      });
      const firstCalDay = $14e0f24ef4ac5c92$export$42c81a444fbfb5d4(month, "en-US");
      const numWeeks = $14e0f24ef4ac5c92$export$ccc1b2479e7dd654(month, "en-US");
      weeks = Array(numWeeks).fill([]);
      for (let w2 = 0; w2 < weeks.length; w2++) {
        weeks[w2] = Array(7).fill(0).map((_, i) => firstCalDay.add({ weeks: w2, days: i }));
      }
    }
  }
  return ` <table class="svelte-143bans"><caption><h3>${escape$1(month.toDate($14e0f24ef4ac5c92$export$aa8b41735afcabd2()).toLocaleDateString("en-US", { month: "long", year: "numeric" }))}</h3></caption> <thead><tr>${each(weeks[0], (day) => {
    return `<th style="text-align: center;" class="svelte-143bans">${escape$1(day.toDate($14e0f24ef4ac5c92$export$aa8b41735afcabd2()).toLocaleDateString("en-US", { weekday: "short" }))}</th>`;
  })}</tr></thead> ${each(weeks, (week) => {
    return `<tr>${each(week, (day) => {
      let inMonth = day.month === month.month;
      return ` <td class="svelte-143bans">${inMonth ? `${byDay && byDay[day.day] ? (() => {
        let first = byDay[day.day][0];
        return ` <a class="${[
          "day svelte-143bans",
          (today.compare(day) === 0 ? "outline" : "") + " " + (today.compare(day) > 0 ? "secondary" : "")
        ].join(" ").trim()}" role="button" href="${"#" + escape$1(first.id, true)}">${escape$1(day.day)} </a>`;
      })() : `<p class="${[
        "day svelte-143bans",
        (today.compare(day) === 0 ? "today" : "") + " " + (!inMonth ? "outOfMonth" : "")
      ].join(" ").trim()}">${escape$1(day.day)} </p>`}` : ``} </td>`;
    })} </tr>`;
  })} </table>`;
});
...
const css$7 = {
  code: 'h1.svelte-k2tjaq a.svelte-k2tjaq{font-size:medium;font-weight:normal}h1.svelte-k2tjaq time.svelte-k2tjaq{color:var(--pico-primary);white-space:nowrap}main.svelte-k2tjaq.svelte-k2tjaq{max-width:1200px !important;display:grid;gap:0 4rem;padding:1.5rem 2.5rem !important;grid-template-columns:1fr min-content;grid-template-areas:"header aside" "section aside" "section aside"}header.svelte-k2tjaq.svelte-k2tjaq{grid-area:header}header.svelte-k2tjaq nav li.svelte-k2tjaq{padding:0.5rem}.content.svelte-k2tjaq.svelte-k2tjaq{grid-area:section}aside.svelte-k2tjaq.svelte-k2tjaq{grid-area:aside;margin-bottom:1rem}aside.svelte-k2tjaq.svelte-k2tjaq{position:sticky;top:1rem;display:flex;flex-direction:column;gap:1rem;align-items:center}@media(max-width: 1024px){main.svelte-k2tjaq.svelte-k2tjaq{grid-template-columns:1fr;grid-template-areas:"header" "aside" "section";align-items:center;padding:1rem !important}aside.svelte-k2tjaq.svelte-k2tjaq{grid-row:unset}aside.svelte-k2tjaq.svelte-k2tjaq{position:static;margin:auto;font-size:larger}}.empty.svelte-k2tjaq.svelte-k2tjaq{text-align:center;padding:1rem}',
  map: '{"version":3,"file":"ListEvents.svelte","sources":["ListEvents.svelte"],"sourcesContent":["<script>\\n    import EventLi from \\"../../../Components/EventLi.svelte\\";\\n    import { CalendarDate } from \\"@internationalized/date\\";\\n    import { inertia } from \\"@inertiajs/svelte\\";\\n    import { groupBy } from \\"lodash\\";\\n    import Calendar from \\"../../../Components/Calendar.svelte\\";\\n    import pluralize from \\"pluralize\\";\\n\\n    export let tag;\\n    export let month;\\n    export let events = [];\\n\\n    let thisMonth, lastMonth, nextMonth, upcoming, past;\\n\\n    $: {\\n        const groups =\\n            events.length &&\\n            groupBy(events, (event) =>\\n                new Date(event.start_time) > new Date() ? \\"upcoming\\" : \\"past\\",\\n            );\\n        upcoming = groups.upcoming || [];\\n        past = groups.past || [];\\n\\n        const [y, m] = month.split(\\"-\\");\\n        thisMonth = new Date(y, m - 1);\\n        lastMonth = new Date(thisMonth.getFullYear(), thisMonth.getMonth() - 1);\\n        nextMonth = new Date(thisMonth.getFullYear(), thisMonth.getMonth() + 1);\\n    }\\n\\n    function getLink(date, tags = true) {\\n        if (!date) return;\\n        const year = date.getFullYear();\\n        const month = date.getMonth() + 1;\\n        if (tags && tag) {\\n            return `/events?month=${year}-${month}&tag=${tag}`;\\n        }\\n        return `/events?month=${year}-${month}`;\\n    }\\n\\n    function format(date) {\\n        return date?.toLocaleDateString(\\"en-US\\", {\\n            month: \\"long\\",\\n            year: \\"numeric\\",\\n        });\\n    }\\n<\/script>\\n\\n{@debug events}\\n\\n<main>\\n    <header>\\n        <hgroup>\\n            <h1>\\n                <span style=\\"color:var(--cmc-red)\\">{tag ?? \\"\\"}</span> Events\\n                <time datetime={thisMonth.toISOString()}\\n                    >{format(thisMonth)}</time\\n                >\\n                {#if tag}\\n                    <a use:inertia href={getLink(thisMonth, false)}\\n                        >Clear Filter</a\\n                    >\\n                {/if}\\n            </h1>\\n            <nav>\\n                <ul>\\n                    <li>\\n                        <a use:inertia href={getLink(lastMonth)}>\\n                            « {format(lastMonth)}\\n                        </a>\\n                    </li>\\n                    <li>\\n                        <a use:inertia href={getLink(nextMonth)}>\\n                            {format(nextMonth)} »\\n                        </a>\\n                    </li>\\n                </ul>\\n            </nav>\\n        </hgroup>\\n    </header>\\n    <aside style=\\"font-size: small; \\">\\n        <Calendar\\n            {events}\\n            month={new CalendarDate(\\n                thisMonth.getFullYear(),\\n                thisMonth.getMonth() + 1,\\n                1,\\n            )}\\n        />\\n        <article>\\n            <h5>Your event here?</h5>\\n            <p>\\n                Submit local events to our community calendar! We\'ll review and\\n                publish them if they meet our <a href=\\"/events/community-events\\"\\n                    >guidelines</a\\n                >.\\n            </p>\\n            <a use:inertia href=\\"/events/submit\\">Submit Event</a>\\n        </article>\\n    </aside>\\n\\n    <div class=\\"content\\">\\n        {#if upcoming.length > 0}\\n            <section>\\n                <h3>Upcoming</h3>\\n                {#each upcoming as event}\\n                    <EventLi {event} />\\n                {/each}\\n            </section>\\n        {/if}\\n        {#if past.length > 0}\\n            <section>\\n                <h3>Past</h3>\\n                {#each past as event}\\n                    <EventLi {event} />\\n                {/each}\\n            </section>\\n        {/if}\\n        {#if events?.length === 0}\\n            <div class=\\"empty\\">\\n                <p>No events found for {format(thisMonth)}</p>\\n            </div>\\n        {/if}\\n    </div>\\n</main>\\n\\n<style>\\n    h1 a {\\n        font-size: medium;\\n        font-weight: normal;\\n    }\\n\\n    h1 time {\\n        color: var(--pico-primary);\\n        white-space: nowrap;\\n    }\\n\\n    main {\\n        max-width: 1200px !important;\\n        display: grid;\\n        gap: 0 4rem;\\n        padding: 1.5rem 2.5rem !important;\\n        grid-template-columns: 1fr min-content;\\n        grid-template-areas: \\"header aside\\" \\"section aside\\" \\"section aside\\";\\n    }\\n\\n    header {\\n        grid-area: header;\\n    }\\n\\n    header nav li {\\n        padding: 0.5rem;\\n    }\\n    .content {\\n        grid-area: section;\\n    }\\n    aside {\\n        grid-area: aside;\\n        margin-bottom: 1rem;\\n    }\\n\\n    aside {\\n        position: sticky;\\n        top: 1rem;\\n        display: flex;\\n        flex-direction: column;\\n        gap: 1rem;\\n        align-items: center;\\n    }\\n\\n    @media (max-width: 1024px) {\\n        main {\\n            grid-template-columns: 1fr;\\n            grid-template-areas: \\"header\\" \\"aside\\" \\"section\\";\\n            align-items: center;\\n            padding: 1rem !important;\\n        }\\n        aside {\\n            grid-row: unset;\\n        }\\n        aside {\\n            position: static;\\n            margin: auto;\\n            font-size: larger;\\n        }\\n    }\\n\\n    .empty {\\n        text-align: center;\\n        padding: 1rem;\\n    }\\n</style>\\n"],"names":[],"mappings":"AA8HI,gBAAE,CAAC,eAAE,CACD,SAAS,CAAE,MAAM,CACjB,WAAW,CAAE,MACjB,CAEA,gBAAE,CAAC,kBAAK,CACJ,KAAK,CAAE,IAAI,cAAc,CAAC,CAC1B,WAAW,CAAE,MACjB,CAEA,gCAAK,CACD,SAAS,CAAE,MAAM,CAAC,UAAU,CAC5B,OAAO,CAAE,IAAI,CACb,GAAG,CAAE,CAAC,CAAC,IAAI,CACX,OAAO,CAAE,MAAM,CAAC,MAAM,CAAC,UAAU,CACjC,qBAAqB,CAAE,GAAG,CAAC,WAAW,CACtC,mBAAmB,CAAE,cAAc,CAAC,eAAe,CAAC,eACxD,CAEA,kCAAO,CACH,SAAS,CAAE,MACf,CAEA,oBAAM,CAAC,GAAG,CAAC,gBAAG,CACV,OAAO,CAAE,MACb,CACA,oCAAS,CACL,SAAS,CAAE,OACf,CACA,iCAAM,CACF,SAAS,CAAE,KAAK,CAChB,aAAa,CAAE,IACnB,CAEA,iCAAM,CACF,QAAQ,CAAE,MAAM,CAChB,GAAG,CAAE,IAAI,CACT,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,GAAG,CAAE,IAAI,CACT,WAAW,CAAE,MACjB,CAEA,MAAO,YAAY,MAAM,CAAE,CACvB,gCAAK,CACD,qBAAqB,CAAE,GAAG,CAC1B,mBAAmB,CAAE,QAAQ,CAAC,OAAO,CAAC,SAAS,CAC/C,WAAW,CAAE,MAAM,CACnB,OAAO,CAAE,IAAI,CAAC,UAClB,CACA,iCAAM,CACF,QAAQ,CAAE,KACd,CACA,iCAAM,CACF,QAAQ,CAAE,MAAM,CAChB,MAAM,CAAE,IAAI,CACZ,SAAS,CAAE,MACf,CACJ,CAEA,kCAAO,CACH,UAAU,CAAE,MAAM,CAClB,OAAO,CAAE,IACb"}'
};
function format(date) {
  return date == null ? void 0 : date.toLocaleDateString("en-US", { month: "long", year: "numeric" });
}
const ListEvents = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { tag } = $$props;
  let { month } = $$props;
  let { events: events2 = [] } = $$props;
  let thisMonth, lastMonth, nextMonth, upcoming, past;
  function getLink(date, tags = true) {
    ...
    if (tags && tag) {
      return `/events?month=${year}-${month2}&tag=${tag}`;
    }
    return `/events?month=${year}-${month2}`;
  }
  ...
  {
    {
      const groups = events2.length && lodashExports.groupBy(events2, (event) => new Date(event.start_time) > /* @__PURE__ */ new Date() ? "upcoming" : "past");
      upcoming = groups.upcoming || [];
      past = groups.past || [];
      const [y, m2] = month.split("-");
      thisMonth = new Date(y, m2 - 1);
      lastMonth = new Date(thisMonth.getFullYear(), thisMonth.getMonth() - 1);
      nextMonth = new Date(thisMonth.getFullYear(), thisMonth.getMonth() + 1);
    }
  }
  return ` <main class="svelte-k2tjaq"><header class="svelte-k2tjaq"><hgroup><h1 class="svelte-k2tjaq"><span style="color:var(--cmc-red)">${escape$1(tag ?? "")}</span> Events
                <time${add_attribute("datetime", thisMonth.toISOString(), 0)} class="svelte-k2tjaq">${escape$1(format(thisMonth))}</time> ${tag ? `<a${add_attribute("href", getLink(thisMonth, false), 0)} class="svelte-k2tjaq">Clear Filter</a>` : ``}</h1> <nav><ul><li class="svelte-k2tjaq"><a${add_attribute("href", getLink(lastMonth), 0)}>« ${escape$1(format(lastMonth))}</a></li> <li class="svelte-k2tjaq"><a${add_attribute("href", getLink(nextMonth), 0)}>${escape$1(format(nextMonth))} »</a></li></ul></nav></hgroup></header> <aside style="font-size: small; " class="svelte-k2tjaq">${validate_component(Calendar, "Calendar").$$render(
    $$result,
    {
      events: events2,
      month: new $35ea8db9cb2ccb90$export$99faa760c7908e4f(thisMonth.getFullYear(), thisMonth.getMonth() + 1, 1)
    },
    {},
    {}
...
const css$6 = {
  code: 'a.svelte-vsucbi:has(article){text-decoration:none;color:inherit}img.svelte-vsucbi{height:100%;margin:auto;transform-origin:center center;transform:scale(1)}figure.svelte-vsucbi{max-height:50vh;aspect-ratio:3/4;flex:auto;position:relative;overflow:hidden;display:flex;align-items:center}figure.svelte-vsucbi::before{content:"";position:absolute;width:100%;height:100%;top:0;left:0;background-image:var(--img);background-size:cover;background-position:center;filter:blur(0.5em) brightness(0.5) saturate(0.5)}article.svelte-vsucbi{overflow:hidden;transition:transform 0.2s;padding:0;display:flex;flex-direction:column;margin:0}article.svelte-vsucbi:hover{transform:scale(1.05);z-index:10}footer.svelte-vsucbi{text-align:center;position:relative;margin:0}footer.svelte-vsucbi::before{content:"";position:absolute;top:-1px;left:0;background:linear-gradient(\n            to bottom,\n            var(--cmc-blue) 0%,\n            var(--cmc-blue) 33%,\n            var(--cmc-yellow) 33%,\n            var(--cmc-yellow) 66%,\n            var(--cmc-red) 66%,\n            var(--cmc-red) 100%\n        );height:0.5em;width:100%}h4.svelte-vsucbi{color:var(--cmc-blue);margin:0;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}',
  map: '{"version":3,"file":"EventCard.svelte","sources":["EventCard.svelte"],"sourcesContent":["<script>\\n    import Icon from \\"@iconify/svelte\\";\\n    import { inertia } from \\"@inertiajs/svelte\\";\\n    export let event;\\n\\n    let loadingImage = true;\\n    function format(isoDate) {\\n        return new Date(isoDate).toLocaleString();\\n    }\\n<\/script>\\n\\n{@debug event}\\n<a href=\\"/events/{event.id}\\" aria-label={event.name}>\\n    <article>\\n        <figure class:loading={loadingImage} style=\\"--img: url({event.poster})\\">\\n            <img\\n                on:loadeddata={() => (loadingImage = false)}\\n                src={event.poster}\\n                alt=\\"Poster for {event.name}\\"\\n            />\\n            <figcaption style=\\"display: none;\\">\\n                Poster for {event.name}\\n            </figcaption>\\n        </figure>\\n        <footer>\\n            <h4>{event.name}</h4>\\n        </footer>\\n    </article>\\n</a>\\n\\n<style>\\n    a:has(article) {\\n        text-decoration: none;\\n        color: inherit;\\n    }\\n\\n    img {\\n        height: 100%;\\n        margin: auto;\\n        transform-origin: center center;\\n        transform: scale(1);\\n    }\\n    figure {\\n        max-height: 50vh;\\n        aspect-ratio: 3/4;\\n        flex: auto;\\n        position: relative;\\n        overflow: hidden;\\n        display: flex;\\n        align-items: center;\\n    }\\n\\n    figure::before {\\n        content: \\"\\";\\n        position: absolute;\\n        width: 100%;\\n        height: 100%;\\n        top: 0;\\n        left: 0;\\n        background-image: var(--img);\\n        background-size: cover;\\n        background-position: center;\\n        filter: blur(0.5em) brightness(0.5) saturate(0.5);\\n    }\\n\\n    article {\\n        overflow: hidden;\\n        transition: transform 0.2s;\\n        padding: 0;\\n        display: flex;\\n        flex-direction: column;\\n        margin: 0;\\n    }\\n    article:hover {\\n        transform: scale(1.05);\\n        z-index: 10;\\n    }\\n\\n    footer {\\n        text-align: center;\\n        position: relative;\\n        margin: 0;\\n    }\\n\\n    footer::before {\\n        content: \\"\\";\\n        position: absolute;\\n        top: -1px;\\n        left: 0;\\n        background: linear-gradient(\\n            to bottom,\\n            var(--cmc-blue) 0%,\\n            var(--cmc-blue) 33%,\\n            var(--cmc-yellow) 33%,\\n            var(--cmc-yellow) 66%,\\n            var(--cmc-red) 66%,\\n            var(--cmc-red) 100%\\n        );\\n        height: 0.5em;\\n        width: 100%;\\n    }\\n\\n    h4 {\\n        color: var(--cmc-blue);\\n        margin: 0;\\n        white-space: nowrap;\\n        overflow: hidden;\\n        text-overflow: ellipsis;\\n    }\\n</style>\\n"],"names":[],"mappings":"AA+BI,eAAC,KAAK,OAAO,CAAE,CACX,eAAe,CAAE,IAAI,CACrB,KAAK,CAAE,OACX,CAEA,iBAAI,CACA,MAAM,CAAE,IAAI,CACZ,MAAM,CAAE,IAAI,CACZ,gBAAgB,CAAE,MAAM,CAAC,MAAM,CAC/B,SAAS,CAAE,MAAM,CAAC,CACtB,CACA,oBAAO,CACH,UAAU,CAAE,IAAI,CAChB,YAAY,CAAE,CAAC,CAAC,CAAC,CACjB,IAAI,CAAE,IAAI,CACV,QAAQ,CAAE,QAAQ,CAClB,QAAQ,CAAE,MAAM,CAChB,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MACjB,CAEA,oBAAM,QAAS,CACX,OAAO,CAAE,EAAE,CACX,QAAQ,CAAE,QAAQ,CAClB,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,GAAG,CAAE,CAAC,CACN,IAAI,CAAE,CAAC,CACP,gBAAgB,CAAE,IAAI,KAAK,CAAC,CAC5B,eAAe,CAAE,KAAK,CACtB,mBAAmB,CAAE,MAAM,CAC3B,MAAM,CAAE,KAAK,KAAK,CAAC,CAAC,WAAW,GAAG,CAAC,CAAC,SAAS,GAAG,CACpD,CAEA,qBAAQ,CACJ,QAAQ,CAAE,MAAM,CAChB,UAAU,CAAE,SAAS,CAAC,IAAI,CAC1B,OAAO,CAAE,CAAC,CACV,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,MAAM,CAAE,CACZ,CACA,qBAAO,MAAO,CACV,SAAS,CAAE,MAAM,IAAI,CAAC,CACtB,OAAO,CAAE,EACb,CAEA,oBAAO,CACH,UAAU,CAAE,MAAM,CAClB,QAAQ,CAAE,QAAQ,CAClB,MAAM,CAAE,CACZ,CAEA,oBAAM,QAAS,CACX,OAAO,CAAE,EAAE,CACX,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,IAAI,CACT,IAAI,CAAE,CAAC,CACP,UAAU,CAAE;AACpB,YAAY,EAAE,CAAC,MAAM,CAAC;AACtB,YAAY,IAAI,UAAU,CAAC,CAAC,EAAE,CAAC;AAC/B,YAAY,IAAI,UAAU,CAAC,CAAC,GAAG,CAAC;AAChC,YAAY,IAAI,YAAY,CAAC,CAAC,GAAG,CAAC;AAClC,YAAY,IAAI,YAAY,CAAC,CAAC,GAAG,CAAC;AAClC,YAAY,IAAI,SAAS,CAAC,CAAC,GAAG,CAAC;AAC/B,YAAY,IAAI,SAAS,CAAC,CAAC,IAAI;AAC/B,SAAS,CACD,MAAM,CAAE,KAAK,CACb,KAAK,CAAE,IACX,CAEA,gBAAG,CACC,KAAK,CAAE,IAAI,UAAU,CAAC,CACtB,MAAM,CAAE,CAAC,CACT,WAAW,CAAE,MAAM,CACnB,QAAQ,CAAE,MAAM,CAChB,aAAa,CAAE,QACnB"}'
};
const EventCard = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { event } = $$props;
  if ($$props.event === void 0 && $$bindings.event && event !== void 0) $$bindings.event(event);
  $$result.css.add(css$6);
  return ` <a href="${"/events/" + escape$1(event.id, true)}"${add_attribute("aria-label", event.name, 0)} class="svelte-vsucbi"><article class="svelte-vsucbi"><figure style="${"--img: url(" + escape$1(event.poster, true) + ")"}" class="${["svelte-vsucbi", "loading"].join(" ").trim()}"><img${add_attribute("src", event.poster, 0)} alt="${"Poster for " + escape$1(event.name, true)}" class="svelte-vsucbi"> <figcaption style="display: none;">Poster for ${escape$1(event.name)}</figcaption></figure> <footer class="svelte-vsucbi"><h4 class="svelte-vsucbi">${escape$1(event.name)}</h4></footer></article> </a>`;
});
...
const css$4 = {
  code: "li.svelte-qb1sg6{list-style:none}article.svelte-qb1sg6{border-radius:0;border-left:4px solid var(--cmc-yellow);box-shadow:none}",
  map: '{"version":3,"file":"PostLi.svelte","sources":["PostLi.svelte"],"sourcesContent":["<script>\\n    export let post;\\n    import { inertia } from \\"@inertiajs/svelte\\";\\n\\n    const format = (isoDate) =>\\n        new Date(isoDate).toLocaleString(undefined, {\\n            month: \\"long\\",\\n            day: \\"numeric\\",\\n            year: \\"numeric\\",\\n        });\\n<\/script>\\n\\n<li>\\n    <article>\\n        <hgroup>\\n            <h3>{post.title}</h3>\\n        </hgroup>\\n        <div style=\\"margin-bottom: 1em;\\">\\n            <div>\\n                {#if post.authors.length}\\n                    By\\n                    {#each post.authors as author}\\n                        <a use:inertia href={author.url}>{author.name}</a>\\n                    {/each} on\\n                {/if}{format(post.published_at)}\\n            </div>\\n            <div class=\\"tags\\">\\n                {#each post.tags as tag}\\n                    <a use:inertia href=\\"/posts?tag={tag}\\" class=\\"tag\\">{tag}</a>\\n                {/each}\\n            </div>\\n        </div>\\n\\n        <div class=\\"content\\">\\n            {@html post.excerpt}\\n        </div>\\n        <nav>\\n            <ul>\\n                <li><a use:inertia href=\\"/posts/{post.id}\\">Full Article</a></li>\\n            </ul>\\n        </nav>\\n    </article>\\n</li>\\n\\n<style>\\n    li {\\n        list-style: none;\\n    }\\n    article {\\n        border-radius: 0;\\n        border-left: 4px solid var(--cmc-yellow);\\n        box-shadow: none;\\n    }\\n</style>\\n"],"names":[],"mappings":"AA6CI,gBAAG,CACC,UAAU,CAAE,IAChB,CACA,qBAAQ,CACJ,aAAa,CAAE,CAAC,CAChB,WAAW,CAAE,GAAG,CAAC,KAAK,CAAC,IAAI,YAAY,CAAC,CACxC,UAAU,CAAE,IAChB"}'
};
const PostLi = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { post } = $$props;
  const format2 = (isoDate) => new Date(isoDate).toLocaleString(void 0, {
    month: "long",
    day: "numeric",
    year: "numeric"
  });
  ...
  return `<li class="svelte-qb1sg6"><article class="svelte-qb1sg6"><hgroup><h3>${escape$1(post.title)}</h3></hgroup> <div style="margin-bottom: 1em;"><div>${post.authors.length ? `By
                    ${each(post.authors, (author) => {
    return `<a${add_attribute("href", author.url, 0)}>${escape$1(author.name)}</a>`;
  })} on
...
const ShowPost = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { post } = $$props;
  let { authors } = $$props;
  if ($$props.post === void 0 && $$bindings.post && post !== void 0) $$bindings.post(post);
...
const css$3 = {
  code: "main.svelte-nd3nkc.svelte-nd3nkc{display:flex;flex-direction:column;align-items:center;max-width:700px !important}main.svelte-nd3nkc iframe.svelte-nd3nkc{width:100%}",
  map: '{"version":3,"file":"Volunteer.svelte","sources":["Volunteer.svelte"],"sourcesContent":["<main>\\n    <section>\\n        <h1>Volunteer with us!</h1>\\n        <p>\\n            We are always looking for volunteers to help us with our mission! If\\n            you are interested in volunteering, please fill out this form with\\n            your preferences.\\n        </p>\\n    </section>\\n    <iframe\\n        title=\\"Corvallis Music Collective Volunteer Form\\"\\n        src=\\"https://docs.google.com/forms/d/e/1FAIpQLSc6fJfjDsSjH7bND6ETgVwU5vmW0Mlr_LUJjbtHxlzN44LvcQ/viewform?embedded=true\\"\\n        width=\\"100%\\"\\n        height=\\"1285\\"\\n        frameborder=\\"0\\"\\n        marginheight=\\"0\\"\\n        marginwidth=\\"0\\">Loading…</iframe\\n    >\\n</main>\\n\\n<style>\\n    main {\\n        display: flex;\\n        flex-direction: column;\\n        align-items: center;\\n        max-width: 700px !important;\\n    }\\n\\n    main iframe {\\n        width: 100%;\\n    }\\n</style>\\n"],"names":[],"mappings":"AAqBI,gCAAK,CACD,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,WAAW,CAAE,MAAM,CACnB,SAAS,CAAE,KAAK,CAAC,UACrB,CAEA,kBAAI,CAAC,oBAAO,CACR,KAAK,CAAE,IACX"}'
};
...
const css$2 = {
  code: 'header.svelte-1hwxbcq.svelte-1hwxbcq{position:relative;display:flex;align-items:center;gap:1rem}header.svelte-1hwxbcq.svelte-1hwxbcq::before{position:absolute;content:"";background:inherit;top:0;left:calc((100vw - 100%) / -2);width:100vw;height:100%;z-index:-1}header.svelte-1hwxbcq img.svelte-1hwxbcq{position:relative;top:-1rem;height:7rem}header.svelte-1hwxbcq hgroup.svelte-1hwxbcq{flex:auto}header.svelte-1hwxbcq.svelte-1hwxbcq::after{content:"";position:absolute;left:calc((100vw - 100%) / -2);bottom:0;width:100vw;height:1.5rem;background:var(--cmc-stripe)}@media(max-width: 768px){header.svelte-1hwxbcq.svelte-1hwxbcq{flex-direction:column;gap:1rem;align-items:center;justify-content:center}header.svelte-1hwxbcq img.svelte-1hwxbcq{position:relative;right:-40px;top:0}header.svelte-1hwxbcq hgroup.svelte-1hwxbcq{text-align:center}header.svelte-1hwxbcq nav.svelte-1hwxbcq{justify-content:center;flex-direction:column;align-items:center}}',
  map: '{"version":3,"file":"PublicHeader.svelte","sources":["PublicHeader.svelte"],"sourcesContent":["<script>\\n    import { inertia } from \\"@inertiajs/svelte\\";\\n    import Icon from \\"@iconify/svelte\\";\\n<\/script>\\n\\n<header class=\\"cmc\\">\\n    <img src=\\"/logo.svg\\" alt=\\"Corvallis Music Collective Logo\\" />\\n    <hgroup>\\n        <h1>Corvallis Music Collective</h1>\\n\\n        <nav>\\n            <ul>\\n                <li><a use:inertia href=\\"/\\">Home</a></li>\\n                <li><a use:inertia href=\\"/events\\">Events</a></li>\\n                <li><a use:inertia href=\\"/posts\\">Articles</a></li>\\n                <li><a use:inertia href=\\"/contribute\\">Contribute</a></li>\\n            </ul>\\n\\n            <ul>\\n                <li>\\n                    <a style=\\"white-space: nowrap\\" href=\\"/contribute/donate\\">\\n                        <Icon icon=\\"mdi:heart\\" />\\n                        Donate\\n                    </a>\\n                </li>\\n            </ul>\\n        </nav>\\n    </hgroup>\\n</header>\\n\\n<style>\\n    header {\\n        position: relative;\\n        display: flex;\\n        align-items: center;\\n        gap: 1rem;\\n    }\\n\\n    header::before {\\n        position: absolute;\\n        content: \\"\\";\\n        background: inherit;\\n        top: 0;\\n        left: calc((100vw - 100%) / -2);\\n        width: 100vw;\\n        height: 100%;\\n        z-index: -1;\\n    }\\n\\n    header img {\\n        position: relative;\\n        top: -1rem;\\n        height: 7rem;\\n    }\\n\\n    header hgroup {\\n        flex: auto;\\n    }\\n\\n    header::after {\\n        content: \\"\\";\\n        position: absolute;\\n        left: calc((100vw - 100%) / -2);\\n        bottom: 0;\\n        width: 100vw;\\n        height: 1.5rem;\\n        background: var(--cmc-stripe);\\n    }\\n\\n    @media (max-width: 768px) {\\n        header {\\n            flex-direction: column;\\n            gap: 1rem;\\n            align-items: center;\\n            justify-content: center;\\n        }\\n        header img {\\n            position: relative;\\n            right: -40px;\\n            top: 0;\\n        }\\n\\n        header hgroup {\\n            text-align: center;\\n        }\\n\\n        header nav {\\n            justify-content: center;\\n            flex-direction: column;\\n            align-items: center;\\n        }\\n    }\\n</style>\\n"],"names":[],"mappings":"AA+BI,oCAAO,CACH,QAAQ,CAAE,QAAQ,CAClB,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,GAAG,CAAE,IACT,CAEA,oCAAM,QAAS,CACX,QAAQ,CAAE,QAAQ,CAClB,OAAO,CAAE,EAAE,CACX,UAAU,CAAE,OAAO,CACnB,GAAG,CAAE,CAAC,CACN,IAAI,CAAE,KAAK,CAAC,KAAK,CAAC,CAAC,CAAC,IAAI,CAAC,CAAC,CAAC,CAAC,EAAE,CAAC,CAC/B,KAAK,CAAE,KAAK,CACZ,MAAM,CAAE,IAAI,CACZ,OAAO,CAAE,EACb,CAEA,qBAAM,CAAC,kBAAI,CACP,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,KAAK,CACV,MAAM,CAAE,IACZ,CAEA,qBAAM,CAAC,qBAAO,CACV,IAAI,CAAE,IACV,CAEA,oCAAM,OAAQ,CACV,OAAO,CAAE,EAAE,CACX,QAAQ,CAAE,QAAQ,CAClB,IAAI,CAAE,KAAK,CAAC,KAAK,CAAC,CAAC,CAAC,IAAI,CAAC,CAAC,CAAC,CAAC,EAAE,CAAC,CAC/B,MAAM,CAAE,CAAC,CACT,KAAK,CAAE,KAAK,CACZ,MAAM,CAAE,MAAM,CACd,UAAU,CAAE,IAAI,YAAY,CAChC,CAEA,MAAO,YAAY,KAAK,CAAE,CACtB,oCAAO,CACH,cAAc,CAAE,MAAM,CACtB,GAAG,CAAE,IAAI,CACT,WAAW,CAAE,MAAM,CACnB,eAAe,CAAE,MACrB,CACA,qBAAM,CAAC,kBAAI,CACP,QAAQ,CAAE,QAAQ,CAClB,KAAK,CAAE,KAAK,CACZ,GAAG,CAAE,CACT,CAEA,qBAAM,CAAC,qBAAO,CACV,UAAU,CAAE,MAChB,CAEA,qBAAM,CAAC,kBAAI,CACP,eAAe,CAAE,MAAM,CACvB,cAAc,CAAE,MAAM,CACtB,WAAW,CAAE,MACjB,CACJ"}'
};
...
const css$1 = {
  code: "footer.svelte-pxd3jc.svelte-pxd3jc{display:grid;grid-template-columns:min-content 1fr auto;align-items:flex-start}footer.svelte-pxd3jc img.svelte-pxd3jc{position:relative;height:7rem;opacity:0.5;filter:saturate(0.5);transform:scaleX(-1)}footer.svelte-pxd3jc h2.svelte-pxd3jc{opacity:0.5;margin:0}footer.svelte-pxd3jc nav.svelte-pxd3jc{display:grid;grid-template-columns:repeat(5, 1fr);margin:0 2rem}footer.svelte-pxd3jc nav ul.svelte-pxd3jc{flex-direction:column;align-items:flex-start}footer.svelte-pxd3jc nav.svelte-pxd3jc li{padding:0.5rem 1rem}@media(max-width: 1024px){footer.svelte-pxd3jc.svelte-pxd3jc{flex-direction:column;gap:1rem;align-items:center}footer.svelte-pxd3jc h2 br.svelte-pxd3jc{display:none}footer.svelte-pxd3jc img.svelte-pxd3jc{transform:scaleX(1);left:2rem}}@media(max-width: 768px){footer.svelte-pxd3jc nav.svelte-pxd3jc{grid-template-columns:1fr;width:100%}footer.svelte-pxd3jc nav ul.svelte-pxd3jc{display:grid;grid-template-columns:repeat(auto-fit, 8rem);align-items:center;justify-content:center;text-align:center}}",
  map: '{"version":3,"file":"PublicFooter.svelte","sources":["PublicFooter.svelte"],"sourcesContent":["<script>\\n    import { inertia } from \\"@inertiajs/svelte\\";\\n    import Icon from \\"@iconify/svelte\\";\\n    import Socials from \\"./Socials.svelte\\";\\n<\/script>\\n\\n<footer>\\n    <div style=\\"font-size: smaller;\\">\\n        <h2>Corvallis <br />Music <br />Collective</h2>\\n        <nav style=\\"margin: 0;\\">\\n            <ul style=\\"flex-direction: row;\\"><Socials /></ul>\\n        </nav>\\n        <div>\\n            <a style=\\"white-space: nowrap;\\" href=\\"mailto:contact@corvmc.org\\">\\n                <Icon icon=\\"mdi:email\\" />\\n                contact@corvmc.org</a\\n            >\\n        </div>\\n    </div>\\n    <nav>\\n        <ul>\\n            <li><a use:inertia href=\\"/\\">Home</a></li>\\n        </ul>\\n\\n        <ul>\\n            <li><a use:inertia href=\\"/events\\">Events</a></li>\\n            <li>\\n                <a use:inertia href=\\"/events/submit\\">Submit Event</a>\\n            </li>\\n            <li>\\n                <a use:inertia href=\\"/events/community-events\\"\\n                    >Submission Guidelines</a\\n                >\\n            </li>\\n        </ul>\\n        <ul>\\n            <li><a use:inertia href=\\"/posts\\">Articles</a></li>\\n        </ul>\\n        <ul>\\n            <li><a use:inertia href=\\"/contribute\\">Contribute</a></li>\\n            <li><a use:inertia href=\\"/contribute/donate\\">Donate</a></li>\\n            <li>\\n                <a use:inertia href=\\"/contribute/volunteer\\">Volunteer</a>\\n            </li>\\n        </ul>\\n    </nav>\\n    <img src=\\"/logo.svg\\" alt=\\"Corvallis Music Collective Logo\\" />\\n</footer>\\n\\n<style>\\n    footer {\\n        display: grid;\\n        grid-template-columns: min-content 1fr auto;\\n        align-items: flex-start;\\n    }\\n    footer img {\\n        position: relative;\\n        height: 7rem;\\n        opacity: 0.5;\\n        filter: saturate(0.5);\\n        transform: scaleX(-1);\\n    }\\n\\n    footer h2 {\\n        opacity: 0.5;\\n        margin: 0;\\n    }\\n\\n    footer nav {\\n        display: grid;\\n        grid-template-columns: repeat(5, 1fr);\\n        margin: 0 2rem;\\n    }\\n    footer nav ul {\\n        flex-direction: column;\\n        align-items: flex-start;\\n    }\\n    footer nav :global(li) {\\n        padding: 0.5rem 1rem;\\n    }\\n\\n    @media (max-width: 1024px) {\\n        footer {\\n            flex-direction: column;\\n            gap: 1rem;\\n            align-items: center;\\n        }\\n\\n        footer h2 br {\\n            display: none;\\n        }\\n        footer img {\\n            transform: scaleX(1);\\n            left: 2rem;\\n        }\\n    }\\n    @media (max-width: 768px) {\\n        footer nav {\\n            grid-template-columns: 1fr;\\n            width: 100%;\\n        }\\n        footer nav ul {\\n            display: grid;\\n            grid-template-columns: repeat(auto-fit, 8rem);\\n            align-items: center;\\n            justify-content: center;\\n            text-align: center;\\n        }\\n    }\\n</style>\\n"],"names":[],"mappings":"AAkDI,kCAAO,CACH,OAAO,CAAE,IAAI,CACb,qBAAqB,CAAE,WAAW,CAAC,GAAG,CAAC,IAAI,CAC3C,WAAW,CAAE,UACjB,CACA,oBAAM,CAAC,iBAAI,CACP,QAAQ,CAAE,QAAQ,CAClB,MAAM,CAAE,IAAI,CACZ,OAAO,CAAE,GAAG,CACZ,MAAM,CAAE,SAAS,GAAG,CAAC,CACrB,SAAS,CAAE,OAAO,EAAE,CACxB,CAEA,oBAAM,CAAC,gBAAG,CACN,OAAO,CAAE,GAAG,CACZ,MAAM,CAAE,CACZ,CAEA,oBAAM,CAAC,iBAAI,CACP,OAAO,CAAE,IAAI,CACb,qBAAqB,CAAE,OAAO,CAAC,CAAC,CAAC,GAAG,CAAC,CACrC,MAAM,CAAE,CAAC,CAAC,IACd,CACA,oBAAM,CAAC,GAAG,CAAC,gBAAG,CACV,cAAc,CAAE,MAAM,CACtB,WAAW,CAAE,UACjB,CACA,oBAAM,CAAC,iBAAG,CAAS,EAAI,CACnB,OAAO,CAAE,MAAM,CAAC,IACpB,CAEA,MAAO,YAAY,MAAM,CAAE,CACvB,kCAAO,CACH,cAAc,CAAE,MAAM,CACtB,GAAG,CAAE,IAAI,CACT,WAAW,CAAE,MACjB,CAEA,oBAAM,CAAC,EAAE,CAAC,gBAAG,CACT,OAAO,CAAE,IACb,CACA,oBAAM,CAAC,iBAAI,CACP,SAAS,CAAE,OAAO,CAAC,CAAC,CACpB,IAAI,CAAE,IACV,CACJ,CACA,MAAO,YAAY,KAAK,CAAE,CACtB,oBAAM,CAAC,iBAAI,CACP,qBAAqB,CAAE,GAAG,CAC1B,KAAK,CAAE,IACX,CACA,oBAAM,CAAC,GAAG,CAAC,gBAAG,CACV,OAAO,CAAE,IAAI,CACb,qBAAqB,CAAE,OAAO,QAAQ,CAAC,CAAC,IAAI,CAAC,CAC7C,WAAW,CAAE,MAAM,CACnB,eAAe,CAAE,MAAM,CACvB,UAAU,CAAE,MAChB,CACJ"}'
};
...
const css = {
  ...
  map: '{"version":3,"file":"Public.svelte","sources":["Public.svelte"],"sourcesContent":["<script>\\n    import Icon from \\"@iconify/svelte\\";\\n    import Header from \\"../Components/PublicHeader.svelte\\";\\n    import Footer from \\"../Components/PublicFooter.svelte\\";\\n    let scrollY;\\n<\/script>\\n\\n<svelte:window bind:scrollY />\\n<div id=\\"top\\"></div>\\n\\n<Header />\\n<slot {...$$props} />\\n<Footer />\\n\\n<a class:show={scrollY > 0} href=\\"#top\\" role=\\"button\\"\\n    ><Icon icon=\\"mdi:arrow-up\\" /> Back to top</a\\n>\\n\\n<style>\\n    a[href=\\"#top\\"] {\\n        position: fixed;\\n        bottom: 1rem;\\n        right: 1rem;\\n        transform: translateX(calc(100% + 2rem));\\n        transition: transform 0.1s;\\n        z-index: 20;\\n    }\\n\\n    a[href=\\"#top\\"].show {\\n        transform: translateX(0);\\n    }\\n</style>\\n"],"names":[],"mappings":"AAmBI,CAAC,CAAC,IAAI,CAAC,MAAM,gBAAE,CACX,QAAQ,CAAE,KAAK,CACf,MAAM,CAAE,IAAI,CACZ,KAAK,CAAE,IAAI,CACX,SAAS,CAAE,WAAW,KAAK,IAAI,CAAC,CAAC,CAAC,IAAI,CAAC,CAAC,CACxC,UAAU,CAAE,SAAS,CAAC,IAAI,CAC1B,OAAO,CAAE,EACb,CAEA,CAAC,CAAC,IAAI,CAAC,MAAM,CAAC,oBAAM,CAChB,SAAS,CAAE,WAAW,CAAC,CAC3B"}'
};
const Public = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return ` <div id="top"></div> ${validate_component(PublicHeader, "Header").$$render($$result, {}, {}, {})} ${slots.default ? slots.default({ ...$$props }) : ``} ${validate_component(PublicFooter, "Footer").$$render($$result, {}, {}, {})} <a href="#top" role="button" class="${["svelte-1d7uhsg", ""].join(" ").trim()}">${validate_component(Icon, "Icon").$$render($$result, { icon: "mdi:arrow-up" }, {}, {})} Back to top</a>`;
});
...
d(
  (page) => createInertiaApp({
    page,
    resolve: (name) => {
      const pages = /* @__PURE__ */ Object.assign({ "./Pages/Admin/Band/ListBands.svelte": __vite_glob_0_0, "./Pages/Public/CommunityEventGuidelines.svelte": __vite_glob_0_1, "./Pages/Public/Contribute.svelte": __vite_glob_0_2, "./Pages/Public/Donate.svelte": __vite_glob_0_3, "./Pages/Public/Event/CreateEvent.svelte": __vite_glob_0_4, "./Pages/Public/Event/ListEvents.svelte": __vite_glob_0_5, "./Pages/Public/Event/ShowEvent.svelte": __vite_glob_0_6, "./Pages/Public/Home.svelte": __vite_glob_0_7, "./Pages/Public/Post/ListPosts.svelte": __vite_glob_0_8, "./Pages/Public/Post/ShowPost.svelte": __vite_glob_0_9, "./Pages/Public/Volunteer.svelte": __vite_glob_0_10 });
      const layouts = /* @__PURE__ */ Object.assign({
        "./Layouts/Admin.svelte": __vite_glob_1_0,
        "./Layouts/Public.svelte": __vite_glob_1_1
      });
      let layout = null;
      const toks = name.split("/");
      for (let i = 1; i < toks.length; i++) {
        const path2 = `./Layouts/${toks.slice(0, -i).join("/")}.svelte`;
        layout = layouts[path2] || layout;
      }
      const page2 = pages[`./Pages/${name}.svelte`];
      if (layout && !page2.layout) return { ...page2, layout: layout.default };
      return page2;
    },
